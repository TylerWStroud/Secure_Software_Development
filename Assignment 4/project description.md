...
<strong>Reverse engineering, XSS attacks, And Sql Injections</strong>  
_CS 4612-01: Secure Software Development, Fall 2025_  
Due: November 6th
...
Demo an SQL injection attack that will:
    ...
    + Retrieve all data from the table without a valid where clause
    statement
